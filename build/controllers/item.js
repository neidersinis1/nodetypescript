...
const getItem = ({ params }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        (0, error_handle_1.handleHttp)(res, "ERROR_GET_ITEM", new error_handle_1.ValidationGetError('ERROR_GET_ITEM'));
    }
});
...
const getItems = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        (0, error_handle_1.handleHttp)(res, "ERROR_GET_ITEMS", new error_handle_1.ValidationGetError('ERROR_GET_ITEMS'));
    }
});
...
const updateItem = ({ params, body }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        (0, error_handle_1.handleHttp)(res, "ERROR_Update_ITEM", new error_handle_1.ValidationUpdateError('ERROR_Update_ITEM'));
    }
});
...
const postItem = ({ body }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        (0, error_handle_1.handleHttp)(res, "ERROR_Post_ITEM", new error_handle_1.ValidationPostError('ERROR_Post_ITEM'));
    }
});
...
const deleteItem = ({ params }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        (0, error_handle_1.handleHttp)(res, "ERROR_Delete_ITEM", new error_handle_1.ValidationGetError('ERROR_Delete_ITEM'));
    }
});
